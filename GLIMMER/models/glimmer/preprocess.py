...
def create_input_features(patient_id):
    ...
    moving_avg_200 = calculate_moving_average(df_train['glucose'].values, Config.MA_WINDOW_SIZE)
    df_train['glucose_MA_200'] = moving_avg_200

    df_train = df_train[df_train['glucose_MA_200'] != 0.0]
    df_train = df_train.reset_index(drop=True)

    moving_avg_200 = calculate_moving_average(df_test['glucose'].values, Config.MA_WINDOW_SIZE)
